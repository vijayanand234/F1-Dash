...
def level1():
    ...
    class Smallvertical(pygame.sprite.Sprite):
        normal = pygame.image.load('images/small_vertical.png')
        def __init__(self, position):
            super(Smallvertical, self).__init__()
            self.rect = pygame.Rect(self.normal.get_rect())
            self.rect.center = position
            self.image = self.normal        
    ...
    pads = [
        ...
        Verticalpad((0,550)),
        Verticalpad((0,250)),
        SmallHorizontalPad((512, 450)),
        SmallHorizontalPad((675, 450)),
        SmallHorizontalPad((125, 450)),
        Verticalpad((1024, 550)),
        Verticalpad((1024,250)),
        Smallvertical((800,500)),
        Smallvertical((530,130)),
        Smallvertical((800,377)),
        PadSprite((200, 600)),
        PadSprite((400, 600)),
        PadSprite((400, 760)),
        PadSprite((0, 760)),
    ...
    car = CarSprite('images/car.png', (50, 715))
    ...
    while 1:
        ...
        if trophy_collision != {}:
            ...
            car.MAX_FORWARD_SPEED = 0
            car.MAX_REVERSE_SPEED = 0
            win_text = win_font.render('Press Space For Next Level', True, (0,255,0))
