...
def level2():
    ...
    car = CarSprite('images/car.png', (70, 720))
    ...
    while 1:
        ...
        for event in pygame.event.get():
            ...
            elif win_condition == True and event.key == K_SPACE:sys.exit(0)
        ...
        if trophy_collision != {}:
            ...
            car.MAX_FORWARD_SPEED = 0
            car.MAX_REVERSE_SPEED = 0
            win_text = win_font.render('Press Space to End Game', True, (0,255,0))
